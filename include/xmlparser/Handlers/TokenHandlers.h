...
#include "XMLParser/Utils/CharacterUtilities.h"
...
public:
    ...
    static std::shared_ptr<OpenPrologComponent> buildOpenPrologComponent(
        std::vector<std::shared_ptr<Character>> &m_tokens,
        size_t &m_index,
        size_t &start);

    static std::shared_ptr<ClosePrologComponent> buildClosePrologComponent(
        std::vector<std::shared_ptr<Character>> &m_tokens,
        size_t &m_index,
        size_t &start);
};
